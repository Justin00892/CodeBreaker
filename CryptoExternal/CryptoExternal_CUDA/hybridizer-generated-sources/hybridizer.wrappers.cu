...
namespace Extreme { namespace Mathematics { 
struct BigInteger ;
} } // Leaving namespace
namespace CryptoExternal { 
struct CryptoExternal___c__DisplayClass0_0 ;
} // Leaving namespace
namespace CryptoExternal { 
struct CryptoExternal ;
} // Leaving namespace
namespace Extreme { namespace Mathematics { 
struct BigInteger ;
} } // Leaving namespace
...
// Intrinsic type Action`2 used
#define __TYPE_DECL_hybridizer_action2___Extreme_Mathematics_BigInteger___System_Threading_Tasks_ParallelLoopState_____
#endif
#pragma endregion
...
{
	if (strcmp (fullTypeName, "CryptoExternal.CryptoExternal") == 0) return 1000000 ; 
	return 0 ;
}
extern "C" DLL_PUBLIC const char* HybridizerGetTypeFromID( const int typeId)
{
	if (typeId == 1000000) return "CryptoExternal.CryptoExternal" ; 
	return "" ;
}
extern "C" DLL_PUBLIC int HybridizerGetShallowSize (const char* fullTypeName) 
{
	#ifdef __TYPE_DECL__CryptoExternal_CryptoExternal___
	if (strcmp (fullTypeName, "CryptoExternal.CryptoExternal") == 0) return 8 ; 
	#endif
	return 0 ;
}
