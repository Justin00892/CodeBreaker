...
{
	if (strcmp (fullTypeName, "Test.Program") == 0) return 1000000 ; 
	return 0 ;
}
extern "C" DLL_PUBLIC const char* HybridizerGetTypeFromID( const int typeId)
{
	if (typeId == 1000000) return "Test.Program" ; 
	return "" ;
}
extern "C" DLL_PUBLIC int HybridizerGetShallowSize (const char* fullTypeName) 
{
	#ifdef __TYPE_DECL__Test_Program___
	if (strcmp (fullTypeName, "Test.Program") == 0) return 8 ; 
	#endif
	return 0 ;
}
